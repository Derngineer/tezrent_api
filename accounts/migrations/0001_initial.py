    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.CharField(blank=True, choices=[('UAE', 'United Arab Emirates'), ('UZB', 'Uzbekistan')], max_length=3, null=True)),
                ('user_type', models.CharField(choices=[('customer', 'Customer'), ('company', 'Company'), ('staff', 'Staff')], default='customer', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.CharField(blank=True, max_length=3, null=True)),
